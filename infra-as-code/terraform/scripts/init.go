...
func main() {
	...
	replaceInFile("../../../deploy-as-code/helm/charts/environments/egov-demo.yaml", data, true)
	fmt.Println("env yaml file updated successfully!")

	replaceInFile("../../../deploy-as-code/helm/charts/environments/egov-demo-secrets.yaml", data, true)
