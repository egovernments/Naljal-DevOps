...
func main() {
	...
	// Read the YAML file
	yamlFile, err := ioutil.ReadFile("../../../deploy-as-code/helm/charts/environments/env.yaml")
	if err != nil {
	...
	err = ioutil.WriteFile("../../../deploy-as-code/helm/charts/environments/env.yaml", []byte(output), 0644)
	if err != nil {
