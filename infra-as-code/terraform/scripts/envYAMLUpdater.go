...
func main() {
	...
	// Read the YAML file
	yamlFile, err := ioutil.ReadFile("../../../deploy-as-code/helm/charts/environments/egov-demo.yaml")
	if err != nil {
	...
	err = ioutil.WriteFile("../../../deploy-as-code/helm/charts/environments/egov-demo.yaml", []byte(output), 0644)
	if err != nil {
